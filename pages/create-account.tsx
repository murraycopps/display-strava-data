  ...
  async function handleClick() {
    ...
    axios
      ...
      .then((response) => {
        ...
        router.push(
          `https://www.strava.com/oauth/authorize?client_id=${clientId}&response_type=code&redirect_uri=${url}/data?_id=${response.data.data.insertedId}&approval_prompt=force&scope=activity:read_all,read,profile:read_all,read_all,activity:read`
        );
      })
      .catch((error) => {
        console.error(error);
